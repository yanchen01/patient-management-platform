...
class Device(Document):
    ...
    date_purchased = me.DateField(required=True)
    ...
    def _set(self, data):
        self._id = data['id']
        self.type = data['type']
        self.date_purchased = datetime.fromisoformat(data['date_purchased'])
    ...
    def json(self):
        return {
            "id": self._id,
            "type": self.type,
            "date_purchased": self.date_purchased.strftime('%m-%d-%Y'),
